    ...
    dispatch_async(dispatch_get_main_queue(), ^
    {
        @autoreleasepool {
            ...
            void (^assetGroupEnumerator)(ALAssetsGroup *, BOOL *) = ^(ALAssetsGroup *group, BOOL *stop)
            {
                ...
                {
                    /*As of iOS6, photo stream is an available feature. However, we want to disable this for our app because since the media isn't physically on the device, it is impossible to import the media into our app*/
